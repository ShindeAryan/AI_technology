...
public class FeedbackController {
    ...
    @PostMapping("/submit")
    public RedirectView submit(@RequestParam String name, @RequestParam String email, @RequestParam String feedback, @RequestParam int rating){
        ...
        return new RedirectView("/feedback.html");
    }
}
